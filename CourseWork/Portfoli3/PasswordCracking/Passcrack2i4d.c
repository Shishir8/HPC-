...
To compile:
     mpicc -o Passcrack2i4d Passcrack2i4d.c -lrt -lcrypt
     
  To run 3 processes on this computer:
    mpirun -n 3 ./Passcrack2i4d
*****************************************************************************/
...
char *encrypted_passwords[] = {
  "$6$KB$w/X6GZ2EB/bwqukL/x3JwialO8k6R13Dm9PF0W51euPmCXPbtK1TEakyz1CqR7vR5VApGwkeuafrT50JAsBCY/",
  "6$KB$MXWeEr08jbMAsddTfoVL6NtvjJ40NeB5itIkEgb921Tuo7Rdu.bmZotbhcXgttdafYCInxNQ3l/2F5qXUexRg1",
  "$6$KB$CXe7XnDOxN707lrFiYzDNM8.YI7ovKUOugYO.Jtt4CBR2Q8tjU.7/RvMhRbDIj3XpFxkYQWAASrvkq0CYR0nY.",
  "$6$KB$FmEgkELxD9vhP1SY.7ufUnKixAwVCL.kpyY9iz1wjc4IqhL/mzimGWC86MdQnqTmZWYnyDWKkEgj2pzTOdyKW."
};
